...
rest_inspec %>% 
  ...
  layout(title = 'Number of Restaurants Graded in Each Month',
...
rest_inspec %>% 
  ...
  layout(title = 'Box Plot of Scores for Each Cuisine Category')
```
...
rest_inspec %>% 
  ...
  layout(title = 'Number of Restaurants for Each Cuisine Category',
